...
<body>
	...
	<spring:message code="admin.panel.service.nav.resources"
		var="resources" />
	<spring:message code="admin.panel.service.nav.baseAdrress"
		var="baseAdrress" />
	<spring:message code="admin.panel.service.nav.help" var="help" />
	<spring:message code="admin.panel.service.nav.cooperation" var="cooperation" />
