...
<div role="tabpanel" class="tab-pane" id="mediaPartners">

	<p
		style="font-size: 14px; margin-left: 15px; font-weight: 400; line-height: 1.42857; margin-top: -2px">
		Wykaz sekcji: <span style="color: #C0C0CA;">patroni medialni</span>
	</p>
	<div class="col-md-3 pull-right">
		<nav style="margin-bottom: -17px; margin-top: -30px">
			<ul class="pagination pagination-sm">
				...
				<li><a href="#" aria-label="Next" style="color: #757575"> <span
