...
public class DataBaseSimpleOperationTest {
    ...
    public void testTranslation() {
		...
		for(int i=0; i<10; i++){
		   ...
		   tempTranslation.setId(new Long(i));
		   tempTranslation.setPolish("record" + i + ": polish");
		   tempTranslation.setEnglish("record" + i + ": english");
	...
	@Test
    public void testPublicationCategory() {
		...
		List<PublicationCategory> tempPublicationCategories = servicePublicationCategory.findAll();
